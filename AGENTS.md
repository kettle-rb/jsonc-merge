...
✅ **CORRECT**:
```bash
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bundle exec rspec
```

✅ **CORRECT**:
```bash
eval "$(mise env -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -s bash)" && bundle exec rspec
```
...
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- env K_SOUP_COV_MIN_HARD=false bundle exec rspec spec/jsonc/merge/smart_merger_spec.rb

# Specific backend tests
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bundle exec rspec --tag mri_backend
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bundle exec rspec --tag rust_backend
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bundle exec rspec --tag ffi_backend
```

### Coverage Reports

```bash
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bin/rake coverage
mise exec -C /home/pboling/src/kettle-rb/ast-merge/vendor/jsonc-merge -- bin/kettle-soup-cover -d
```
