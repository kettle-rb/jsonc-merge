...
# jsonc-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install jsonc-merge-1.0.0.gem in...
# rake install:local                          # Build and install jsonc-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install jsonc-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template jsonc-merge against itse...
# rake kettle:jem:template                    # Template jsonc-merge files into the curren...
