...
# Debug script to investigate MRI backend behavior with ruby_tree_sitter
#
...
puts "=" * 80
puts "MRI Backend Debug Script for jsonc-merge"
puts "=" * 80
...
# Check MRI backend availability
...
begin
  ...
  puts "Please ensure tree-sitter-jsonc is installed."
  puts "Run: ts-grammar-action install jsonc"
  exit(1)
end
puts
    ...
    if obj
      ...
      if obj.pairs.any?
        ...
        if pair_node.respond_to?(:child_by_field_name)
          ...
          puts "child_by_field_name NOT AVAILABLE"
        end
        puts
...
puts "=" * 80
puts
puts "If tests pass, MRI backend is working correctly!"
puts "Compare results with other backends to identify differences."
